...
int adressOfTheCell(char col,int row)
{
	...
	/*formule for the adress of the cell on the board (8*(row-1)+col)*/
...
int isKingMovable(char *board,char sourceCol,int sourceRow,char targetCol,int targetRow)
{
		...
		(targetRow==sourceRow || targetRow==sourceRow+1 || targetRow==sourceRow-1))	
	{
		...
		if(whatIsInTheCell(board,sourceCol,sourceRow)=='K')
		{
			/*checks if there is enemy king nearby */
			if ((whatIsInTheCell(board,targetCol+1,targetRow)=='k') ||
				(whatIsInTheCell(board,targetCol-1,targetRow)=='k') ||
				(whatIsInTheCell(board,targetCol,targetRow+1)=='k') ||
				(whatIsInTheCell(board,targetCol,targetRow-1)=='k') ||
				(whatIsInTheCell(board,targetCol+1,targetRow+1)=='k') ||
				(whatIsInTheCell(board,targetCol+1,targetRow-1)=='k') ||
				(whatIsInTheCell(board,targetCol-1,targetRow+1)=='k') ||
				(whatIsInTheCell(board,targetCol-1,targetRow-1)=='k') )
			{
			...
			if(whatIsInTheCell(board,targetCol+1,targetRow+1)=='p' || 
				whatIsInTheCell(board,targetCol-1,targetRow+1)=='p')
			{
				return 0;
			}

			/*checks if there is a knight nearby*/
			if (whatIsInTheCell(board,targetCol+1,targetRow+2)=='n' ||
				whatIsInTheCell(board,targetCol+2,targetRow+1)=='n' ||
				whatIsInTheCell(board,targetCol+1,targetRow-2)=='n' ||
				whatIsInTheCell(board,targetCol+2,targetRow-1)=='n' ||
				whatIsInTheCell(board,targetCol-1,targetRow+2)=='n' ||
				whatIsInTheCell(board,targetCol-2,targetRow+1)=='n' ||
				whatIsInTheCell(board,targetCol+1,targetRow-2)=='n' ||
			...
			for(i=targetCol+1;i<='h';++i)
			{
				cellContent=whatIsInTheCell(board,i,targetRow);
				
				/*indicates that the pass is safe if there is a friendly piece on the row*/
				...
				if((cellContent=='q' || cellContent=='r') && flag==0)
				{
					return 0;
				}
			}
			...
			for(i=targetRow+1;i<=8;++i)
			{
				cellContent=whatIsInTheCell(board,targetCol,i);
				
				/*indicates that the pass is safe if there is a friendly piece on the column*/
				if((cellContent>='A' && cellContent<='Z') || cellContent=='p' ||
					cellContent=='n' || cellContent=='b' || cellContent=='k')
				{
					flag=1;
				...
				/*quits if there is queen or rook on the column and the pass is not safe */
				if((cellContent=='q' || cellContent=='r') && flag==0)
				{
					return 0;
				}
			...
			for(i=targetRow-1;i>=1;--i)
			{
				cellContent=whatIsInTheCell(board,targetCol,i);
				
				/*indicates that the pass is safe if there is a friendly piece on the  clumn*/
				if((cellContent>='A' && cellContent<='Z') || cellContent=='p' ||
					cellContent=='n' || cellContent=='b' || cellContent=='k')
				{
					flag=1;
			...
			for(i=targetCol+1,j=targetRow+1;i<='h' && j<=8;++i,++j)
			{
				cellContent=whatIsInTheCell(board,i,j);

			 	/*indicates that the pass is safe if there is a friendly piece on the clumn*/
				if((cellContent>='A' && cellContent<='Z' && cellContent!='K') || cellContent=='r' ||
				...
				/*quits if there is queen or rook on the column and the pass is not safe */
				if((cellContent=='b' || cellContent=='q') && flag==0)
				{
					return 0;
				}
			}
			...
			for(i=targetCol+1,j=targetRow-1;i<='h' && j>=1;++i,--j)
			{
				cellContent=whatIsInTheCell(board,i,j);
			...
			for(i=targetCol-1,j=targetRow+1;i>='a' && j<=8;--i,++j)
			{
				cellContent=whatIsInTheCell(board,i,j);
			...
			for(i=targetCol-1,j=targetRow-1;i>='a' && j>=1;--i,--j)
			{	
				cellContent=whatIsInTheCell(board,i,j);
...
int isPawnMovable(char *board,char sourceCol,int sourceRow,char targetCol,int targetRow)
{
	if((whatIsInTheCell(board,sourceCol,sourceRow)=='p' &&
		(whatIsInTheCell(board,targetCol,targetRow)>='a' && 
		whatIsInTheCell(board,targetCol,targetRow)<='z')) || 
